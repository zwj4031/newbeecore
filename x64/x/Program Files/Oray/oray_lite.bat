...
start "" "X:\Program Files\WinXShell.exe" -ui -jcfg wxsUI\UI_DL\main.jcfg -nbapp oraylite&&exit
:var
set appname=向日葵远程
set appfile=向日葵lite.exe
set apppath=%~dp0%appfile%
set appurl=https://sunlogin.oray.com/zh_CN/download/download?id=152^&x64=1
set aria2cargs=
