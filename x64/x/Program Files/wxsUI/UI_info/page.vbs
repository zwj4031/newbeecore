...
Set objShell = CreateObject("Shell.Application") 
Set objFolder = objShell.BrowseForFolder(WINDOW_HANDLE, "你要把[虚拟内存页面文件]设置何处？适合小内存机器使用QQ微信等工具，默认8G", OPTIONS, strPath) 
If objFolder Is Nothing Then 
'msgbox "您没有选择任何有效目录!" 
End If 
Set objFolderItem = objFolder.Self 
objPath = objFolderItem.Path 
WSHshellA.run  "pecmd PAGE " & objPath &"\PAGEFILE.SYS 8192 8192",0 ,true
