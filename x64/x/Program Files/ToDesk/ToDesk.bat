...
start "" "X:\Program Files\WinXShell.exe" -ui -jcfg wxsUI\UI_DL\main.jcfg -nbapp todesk&&exit
:var
set appname=ToDesk全功能版
set appfile=ToDesk_Setup.exe
set apppath=X:\Program Files (x86)\ToDesk\ToDesk.exe
set appurl=https://dl.todesk.com/windows/ToDesk_Setup.exe
set aria2cargs=
set runargs=
title=正在下载%appname%
...
checksetup
if exist %appfile% start "" %appfile% /S &&goto checkefile
call :downsetup
exit /b
